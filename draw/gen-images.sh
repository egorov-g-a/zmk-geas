...
keymap --config keymap_config.yaml parse --columns 12 --layer-names Base Diktor NAV FN NUM SYM Sys Mouse --zmk-keymap ../config/corne.keymap >corne_orig.yaml
keymap --config keymap_config_rus.yaml parse --columns 12 --layer-names Base Diktor NAV FN NUM SYM Sys Mouse --zmk-keymap ../config/corne.keymap >corne_rus.yaml
